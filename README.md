...
<img src="truss_3_1_ba.png" width="300">

Παρατηρείστε ότι:
* Ένα k-δικτύωμα δεν είναι απαραίτητο να αποτελείται από k κόμβους.
* Ένα k-δικτύωμα δεν είναι απαραίτητο να αποτελείται από κόμβους που είναι πλήρως συνδεδεμένοι μεταξύ τους (αυτό ονομάζεται *κλίκα*, clique).
